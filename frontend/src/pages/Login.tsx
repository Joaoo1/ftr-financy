  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <Button type="submit" size="lg" className="h-10 sm:h-12 ">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Button
            ...
            className="h-10 sm:h-12 bg-white border border-gray-300 text-gray-700 text-sm sm:text-base font-medium font-['Inter'] rounded-lg hover:bg-gray-50"
          >
            <UserRoundPlus className="w-4 h-4 sm:w-4.5 sm:h-4.5 mr-2" />
            Criar conta
          </Button>
        </div>
      </form>
